...
+ (EKManagedObjectMapping *)objectMapping
{
    ...
    [mapping mapKeyPath:FSFilmPosterUrlIdKey toProperty:NSStringFromSelector(@selector(posterUrl)) withValueBlock:^id(NSString *key, id value, NSManagedObjectContext *context)
    {
